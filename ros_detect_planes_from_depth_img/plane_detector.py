...
from ros_detect_planes_from_depth_img.utils.lib_io import read_yaml_file
from ros_detect_planes_from_depth_img.utils.lib_ransac import PlaneModel, RansacPlane
from ros_detect_planes_from_depth_img.utils.lib_geo_trans import world2pixel
from ros_detect_planes_from_depth_img.utils_rgbd.lib_rgbd import CameraInfo, resize_color_and_depth
from ros_detect_planes_from_depth_img.utils_rgbd.lib_open3d import wrap_open3d_point_cloud_with_my_functions
from ros_detect_planes_from_depth_img.utils_rgbd.lib_plot_rgbd import drawMaskFrom2dPoints, draw3dArrowOnImage
...
def test_PlaneDetector():
    ...
    img_color = cv2.imread("../ex1_color.jpg", cv2.IMREAD_UNCHANGED)
    img_depth = cv2.imread("../ex1_depth.png", cv2.IMREAD_UNCHANGED)
    config_file = "ros_detect_planes_from_depth_img/config/plane_detector_config.yaml"
    camera_info_file_path = "ros_detect_planes_from_depth_img/data/cam_params_realsense.json"
...
def test_PlaneDetector_send(img_color, img_depth):
