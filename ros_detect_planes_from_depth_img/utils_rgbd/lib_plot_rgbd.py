...
if True:  # Add project root
    ...
    from ros_detect_planes_from_depth_img.utils.lib_geo_trans import xyz_to_T, rot3x3_to_4x4, rot, rotx, roty, rotz
    from ros_detect_planes_from_depth_img.utils.lib_geo_trans import world2pixel, world2cam, cam2pixel
